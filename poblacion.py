...
def poblacion():
	...
	add_mantenimiento('pr1','proyector','2017-05-02','2017-05-04','10:00','11:00','preventivo')
	add_mantenimiento('pr3', 'proyector', '2017-05-05', '2017-05-06', '12:00', '16:00', 'preventivo')
	add_mantenimiento('nb2', 'notebook', '2017-06-02', '2017-06-04', '10:00', '11:00', 'correctivo')
	add_mantenimiento('nb1', 'notebook', '2017-05-02', '2017-05-04', '10:00', '11:00', 'preventivo')
	add_mantenimiento('aula A55', 'aula', '2017-06-12', '2017-06-14', '08:00', '11:00', 'preventivo')

	add_solicitud('pr1','2017-06-06', '10:00', '11:15','admin')
	add_solicitud('aula A55', '2017-06-05', '8:00', '9:15', 'luis')
	add_solicitud('nb2', '2017-06-05', '15:00', '18:45', 'fatima')
